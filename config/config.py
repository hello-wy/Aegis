...
class MotionFromGazeConfig(ArgumentParser):
    def __init__(self):
        ...
        self.train_configs.add_argument('--mpjpe_loss_weight', type=float, default=2.0)
        self.train_configs.add_argument('--latent_loss_weight', type=float, default=1.0)
        self.train_configs.add_argument('--velocity_loss_weight', type=float, default=0.5)
        self.train_configs.add_argument('--acceleration_loss_weight', type=float, default=0.2)
        self.train_configs.add_argument('--semantic_loss_weight', type=float, default=0.5)
        self.train_configs.add_argument('--contact_loss_weight', type=float, default=0.5)
        self.train_configs.add_argument('--contact_threshold', type=float, default=0.08)
        self.train_configs.add_argument('--contact_scene_points', type=int, default=2048)
        ...
        self.eval_configs.add_argument('--dataset_csv', default='dataset_with_token_motion_label', type=str)
        ...
        self.prototype_configs = self.add_argument_group('semantic_prototype')
        self.prototype_configs.add_argument('--num_semantic_classes', type=int, default=8)
        self.prototype_configs.add_argument('--prototypes_per_class', type=int, default=4)
        self.prototype_configs.add_argument('--prototype_temperature', type=float, default=0.1)
